          ...
          <div className="bg-surface-container-low rounded-[2rem] p-8 md:p-12">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-[10px] text-on-surface font-semibold">{displayDate}</p>
              </div>
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-[10px] text-on-surface font-semibold">{event.event_time}</p>
              </div>
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-[10px] text-on-surface font-semibold">{event.location}</p>
              </div>
            </div>
          </div>
        </div>
